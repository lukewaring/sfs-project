...
class App extends React.Component {
  ...
  deleteDebt(selectedRowIds) {
    selectedRowIds.map(id =>
      fetch(`http://localhost:3001/debts/${id}`, {
        method: "DELETE",
        headers: {
    ...
    return (
      <div style={{ padding: "2rem" }}>
        ...
        <MaterialTable
          ...
          columns={[
            ...
            },
            {
              ...
              headerStyle: { fontWeight: "bold", textAlign: "right" },
              type: "numeric"
            },
            {
              title: "Balance",
        ...
        {this.state.isFormVisible ? (
          ...
          <Button onClick={this.toggleForm} variant="contained" color="primary">
            Add Debt
          </Button>
        )}
        <br></br>
        ...
        <Button onClick={this.removeDebt} variant="contained" color="secondary">
          Remove Debt(s)
        </Button>
        <br></br>
        <br></br>
        ...
        <div>
          <div style={{ textAlign: "right", backgroundColor: "#a6d4fa" }}>
            <strong>Total: ${this.state.selectedRowsTotal.toFixed(2)}</strong>
          </div>
          <br></br>
          <span style={{ marginRight: "14rem" }}>
            <strong>Total Row Count: {this.state.debts.length}</strong>
          </span>
          <span>
            <strong>
              Checked Row Count: {this.state.selectedRowsArr.length}
            </strong>
          </span>
        </div>
      </div>
